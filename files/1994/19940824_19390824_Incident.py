...
PAGE = Page(blocks=(
    ...
    PageBlock(parts=(
        ...
        """,)),
        Paragraph(text=("""
            Lately, I've been practicing not chasing every stray thought that pulls me off course.
            It's a way to conserve mental energy for what truly matters.
            Once I catch myself spiraling into something unimportant or irrelevant, I pause, acknowledge and label the thought, and let it pass - without letting it lead me further astray.
            Like for example... ehm, now.
            This is almost comically meta: I’m labeling the thought of labeling thoughts.
            But there it is - LABELING THOUGHTS in action.
       """,)),
        Paragraph(text=("""
            Where was I?
            Yes, the incident. 

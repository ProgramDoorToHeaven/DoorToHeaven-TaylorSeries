...
PAGE = Page(blocks=(
    ...
    PageBlockTypeWriter(parts=(
        ...
        Paragraph(text=("""
            ...
            Our orders are clear and remain unchanged:
            deliver the cargo to Boston, no questions asked.
            The men are uneasy, but discipline holds.
            The Achilles cuts through the waves, her course set, her cargo secured.
            The cargo shifts occasionally, a low metallic groan echoing through the hold.
            The crew casts glances, but no one asks.
            Not yet. 
        """,)),
        Paragraph(text=("""
    ...
    PageBlockTypeWriter(parts=(
        ...
        Paragraph(text=("""
            ...
            The bosun and I have agreed to log this as an attack by saboteurs, but the truth is far stranger.
        """,)),
        Paragraph(text=("""
